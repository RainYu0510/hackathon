...
func build_level() -> void:
	next_scene_path = "res://levels/Level02.tscn"
	...
	# 起點那道門就是出口,必須拿到鑰匙才算數。P1 開場就生在門框內
	# (門框 x[100,200] y[445,615],出生點 (170,560)),所以 exit_trigger 會等
	# 他往右去拿鑰匙、離開過門框之後才武裝 —— 擋掉「生在門裡」被誤判成走進門。
